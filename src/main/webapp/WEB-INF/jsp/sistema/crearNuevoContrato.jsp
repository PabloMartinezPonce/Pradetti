<%-- 
    Document   : crearNuevoContrato
    Created on : 15/11/2016, 12:11:06 PM
...
<h2 class="selectAction">${(model.edicion)?"Edición de un contrato para colaboradores":"Crear un nuevo contrato para colaboradores"}</h2>
<div class="col-xs-12 lnbrk"></div>
<div class="sistemaContainer">
    <form method="post" id="formCrearNuevoContratoColaboradores" action="${pageContext.request.contextPath}/sistema/datos-contrato-colaboradores.htm">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    ...
                    <input value="${model.contrato.nombre}" type="text" id="nmbrCntrtID" class="form-control toUpperText" placeholder="Campo requerido" aria-describedby="nmbrCntrt" name="nmbrCntrt" required title="Nombre del contrato" maxlength="100" autocomplete="off" minlength="5"   pattern="[0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]+(\s[0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*">
                </div>
            </div>
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel-heading panel-heading-colaborator" role="tab" id="headingOne">
                      <h4 class="panel-title panel-title-colaborator">
                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                          <span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Del colaborador
                        </a>
                      </h4>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                      <div class="panel-body">
                          <c:forEach var="delColaborador" items="${model.DatosDelColaborador}">
                                <button type="button" class="btn btn-component-colaborator" value="{{${delColaborador.key}}}">
                                    ${delColaborador.value}
                                </button>                               
                          </c:forEach>
                      </div>
                    </div>
                    ...
                    <div class="panel-heading panel-heading-client" role="tab" id="headingTwo">
                      <h4 class="panel-title panel-title-client">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                          <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Del contratista
                        </a>
                      </h4>
                    </div>
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                      <div class="panel-body">
                          <c:forEach var="delContratista" items="${model.DatosDelContratista}">
                                <button type="button" class="btn btn-component-client" value="{{${delContratista.key}}}">
                                    ${delContratista.value}
                                </button> 
                        </c:forEach>
                      </div>
                    </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                      <div class="panel-body">
                          <c:forEach var="delContrato" items="${model.DatosContratoContratistaColaborador}">
                                <button type="button" class="btn btn-component-agreement" value="{{${delContrato.key}}}">
                                    ${delContrato.value}
                                </button> 
                           </c:forEach> 
                      </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseZero" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                      <div class="panel-body">
                                <button type="button" class="btn btn-component-special-component" value="{{FIRMA_DEL_COLABORADOR_Y_DEL_CONTRATISTA}}">
                                    Firma del colaborador y<br> del contratista
                                </button> 
                                <button type="button" class="btn btn-component-special-component" value="{{FIRMA_DE_LOS_TESTIGOS}}">
