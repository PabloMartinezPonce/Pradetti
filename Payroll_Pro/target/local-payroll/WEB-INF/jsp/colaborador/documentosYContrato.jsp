<%-- 
    Document   : documentosYContrato
    Created on : 15/05/2017, 11:33:47 AM
    ...
    <body>
        ...
        <div class="col-xs-12 main" id="sidebody"> 
            ...
            <div class="col-lg-10 col-lg-offset-1" id="frameContainer">    
                ...
                <h2 class="selectAction">Expediente sin contrato</h2>
                <div class="row"> 
                ...
                <div class="row">                            
                    ...
                    <div class="col-xs-12 col-md-4">         
                            <form method="post" action="${pageContext.request.contextPath}/colaborador/verificar-expediente-contrato.htm">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" id="_${tipoDocumento.idTipoDocumento}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${tipoDocumento.nombreDocumento.equalsIgnoreCase('Contrato')==true}">
                                                    <button type="button" class="btn btn-default redireccionarVentana" title="Generar Contrato" value="${pageContext.request.contextPath}/colaborador/datos-del-contrato/${model.agremiado.idAgremiado}.htm">
                                                        <span class="glyphicon glyphicon-file" aria-hidden="true"></span>&nbsp;Generar Contrato
                                                    </button>
                                            </c:if>
                                            <c:if test="${tipoDocumento.nombreDocumento.equalsIgnoreCase('Contrato por asimilados')==true}">
                                                    <button type="button" class="btn btn-default redireccionarVentana" title="Generar Contrato" value="${pageContext.request.contextPath}/colaborador/datos-del-contrato/${model.agremiado.idAgremiado}.htm">
                                                        <span class="glyphicon glyphicon-file" aria-hidden="true"></span>&nbsp;Generar Contrato
                                                    </button>
                                            </c:if>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-2 col-md-offset-1">                            
                            <button type="reset" value="${pageContext.request.contextPath}/colaboradores/expedientes-sin-contrato.htm" class="form-control btn btn-info btn-lg center-btn btn-helper redireccionar">
                              <b>Volver</b>
                          </button>
                        </div>
                  </div> 
