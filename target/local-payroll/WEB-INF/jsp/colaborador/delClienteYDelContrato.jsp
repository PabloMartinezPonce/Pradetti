<%-- 
    Document   : delClienteYDelContrato
    Created on : 26/02/2018, 05:00:41 PM
    ...
    <body>
        ...
        <div class="col-xs-12 main" id="sidebody">
            ...
            <div class="col-xs-12 col-lg-10 col-lg-offset-1" id="frameContainer">   
                <form method="post" action="${pageContext.request.contextPath}/colaborador/registrar-colaborador.htm">
                <%@include file="../fragmentos/menuColaborador.jsp" %>
                <h2 class="selectAction">Registro de un nuevo colaborador</h2>
                <div class="row">
                    <div class="col-sm-12 col-md-8 col-md-offset-2">
                                    <div class="input-group">
                                        <span class="input-group-addon" id="clnt" >&nbsp;&nbsp;&nbsp;&nbsp;Cliente&nbsp;&nbsp;&nbsp;</span>
                                        <select  id="selectClienteOption" name="cliente" class="form-control" placeholder="Campo requerido" aria-describedby="clnt"  required >                                            
                                            <option  value=""></option>   
                    ...
                    <div class="col-sm-12 col-md-8 col-md-offset-2">
                                    <div class="input-group">
                                        ...
                                        <select id="selectBoxContratistasWithDocument" name="contrato" class="form-control" placeholder="Campo requerido" aria-describedby="st"  required >
                                            <option value=""></option>    
                                        </select>
                                    </div>
                    </div>           
