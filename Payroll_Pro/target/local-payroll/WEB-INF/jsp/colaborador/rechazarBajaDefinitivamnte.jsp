<%-- 
    Document   : rechazarBajaDefinitivamnte
    Created on : 22/05/2017, 12:27:08 PM
        ...
        <div class="container bodie">
            ...
            <div class="row">
                <section class="section" id="home">
                    <div class="sec-header">Rechazar Solicitud de Baja Definitivamente
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="descriptor">
                                    ...
                                    <span class="content" title="Número de Seguro Social" id="nss">${model.datosLaborales.numeroSeguro}</span>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="col-md-12">
                                    <form action="${pageContext.request.contextPath}/colaborador/rechazar-baja-definitivamente.htm" method="post">
                                        <div class="row">
                                            <div class="col-xs-12 lnbrk"   ></div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" name="stts" value="${model.stts}">
                                                  <span class="input-group-addon" id="nmbrCmplt">Motivo de Rechazo</span>
                                                  <input type="text" class="form-control trimTxt" id="nmbrCmpltID" placeholder="Campo requerido" aria-describedby="nmbrCmplt" name="motivo" required title="Motivo del rechazo de la solicitud" minlength="3"   pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(\s[0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*">
                                                </div>
                                                </div>
                                            <div class="col-xs-12 lnbrk"   ></div>
