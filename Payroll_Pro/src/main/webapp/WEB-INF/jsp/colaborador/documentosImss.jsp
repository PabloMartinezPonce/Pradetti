<%-- 
    Document   : documentosImss
    Created on : 16/05/2017, 12:25:13 PM
    ...
    <body>
        ...
        <div class="col-xs-12 main" id="sidebody"> 
            ...
            <div class="col-lg-10 col-lg-offset-1" id="frameContainer">    
                ...
                <h2 class="selectAction">Alta en proceso</h2>
                <div class="row"> 
                ...
                <div class="row">                            
                    ...
                    <div class="col-xs-12 col-md-8">
                         <h1 >Documentos requeridos para continuar</h1>
                    </div>
                    <div class="col-xs-12 col-md-4">  
                        <sec:authorize access="hasAnyRole('Subir_Alta_Altas_En_Proceso')">       
                            <form method="post" action="${pageContext.request.contextPath}/colaborador/verificar-expediente-imss.htm">
                            ...
                            <c:if test="${tipoDocumento.status}" > 
                                <form action="" method="post" enctype="multipart/form-data" id="_${tipoDocumento.idTipoDocumento}">
                                    <tr>
                                        ...
                                        <td><button class="btn subirArchivosImss" value="${tipoDocumento.idTipoDocumento}"  type="button" title="cargar archivo"><span  class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span></td>
                                    </tr>
                                </form>
                            </c:if>
                        </c:forEach>       
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-2 col-md-offset-1">                            
                            <button type="reset" value="${pageContext.request.contextPath}/colaboradores/altas-en-proceso.htm" class="form-control btn btn-info btn-lg center-btn btn-helper redireccionar">
                              <b>Volver</b>
                          </button>
                        </div>
                  </div> 
